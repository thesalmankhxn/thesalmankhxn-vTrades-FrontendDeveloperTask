...
/**
 * Dashboard component for the protected area
        ...
        <div className='bg-background min-h-screen'>
            <div className='mx-auto w-full max-w-[1440px] px-4 py-8'>
                <header className='mb-8'>
                    <h1 className='text-foreground text-3xl font-bold'>Welcome to vTrades Dashboard</h1>
                ...
                <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div className='bg-card rounded-lg border p-6 shadow-sm'>
                        ...
                        <p className='text-muted-foreground mb-4 text-sm'>
                            Analyze team goals, progress, and achievements
                        </p>
